...
def save_checkpoint(
    ...
    torch.save(state, fpath)         #MAIN SAVING COMMAND
...
def resume_from_checkpoint(fdir, model, optimizer=None, scheduler=None):
    ...
    #FIRSTLY LOADING UP FROM THE CHECKPOINT
    ...
    checkpoint = load_checkpoint(fpath)  #GOT IT AS A DICTIONARY HERE

    #LOADING THE STATE_DICT TO THE MODEL, OPTIMISER AND THE SCHEDULER
