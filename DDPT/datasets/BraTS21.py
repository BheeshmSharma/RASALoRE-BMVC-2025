...
class BraTS21(DatasetBase):

    dataset_dir_name = "BraTS21"
    ...
    def __init__(self, cfg):
        ...
        if(cfg.DATASET.TRAIN_PERCENT!=0):  #THIS IS RUN DURING TRAINING
          self.split_path = os.path.join(self.dataset_dir, "split_brats21.json")
          self.split_fewshot_dir = os.path.join(self.dataset_dir, "split_fewshot_train")
        else:                              #THIS IS RUN DURING TESTING
          self.split_path = os.path.join(self.dataset_dir, "split_brats21_full.json")
